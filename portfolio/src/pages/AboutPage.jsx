...
export default function AboutPage() {
  return <div className="spatial-site about-page">
    ...
    <main id="main-content">
      <header className="about-hero"><h1>我不是虚构的资深专家。<br /><em>我正在认真地学习，也已经开始构建。</em></h1><p>{profile.role}</p></header>
      ...
      <section className="about-observe"><EyeScene /><div><h2>观察内容，理解用户，<br />再决定做什么。</h2><p>我熟悉内容平台的创作节奏，也愿意承认能力仍在生长。学习速度、执行力和产品意识，是我目前最确定的积累。</p></div></section>
